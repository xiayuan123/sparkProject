...
//        System.out.println("clickActionRDD:" + clickActionRDD.count());
    ...
    private static JavaPairRDD<Long, Row> getCityid2CityInfoRDD(SQLContext sqlContext){
        String url = "jdbc:mysql://localhost:3306/sparkproject";
        String user = "root";
        ...
        Dataset cityInfoDF = sqlContext.read().format("jdbc")
    ...
    private static void generateTempClickProductBasicTable(
        ...
        //将上面的javapairRDD转化为javaRDD<ROW>才能把RDD转化为Dateset
        ...
        //基于javaRDD<Row>的格式，就可以转化为dataFrame
        ...
        Dataset df = sqlContext.createDataFrame(mappedRDD, schema);
...
//                        + "AND date<='" + endDate + "'";
//
//        Dataset clickActionDF = sqlContext.sql(sql);
//
